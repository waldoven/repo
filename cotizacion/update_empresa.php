...
<body>
  <div class="container-fluid">
    ...
    <div class="row mt-3 no-gutters">
      <div class="col-lg-5"><h3 class="texto">Modificar Cotizacion de Empresa</h3></div>
...
<!-- /PopUP partes -->
  ...
  <div id="MyModal" class="modal fade" role="dialog" data-control="<?php echo $cotizacionEliminarControl; ?>" data-action="cotizacion/update">
