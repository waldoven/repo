...
//    $nom_cliente = $_REQUEST['nomcliente'];
  ...
  // search for CLIENTES data
    $pdo = Database::connect();
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sql = "SELECT * FROM ventas_part WHERE num_venta = $num_venta";
//echo $sql;
    $stmt = $pdo->query($sql);
    $rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
    foreach($rows as $row){
...
<body>
  <div class="container-fluid">
    ...
    <div class="row mt-3 no-gutters">
      <div class="col-lg-5"><h3 class="texto">Modificar Venta de Particular</h3></div>
...
<!-- /PopUP partes -->
  ...
  <div id="MyModal" class="modal fade" role="dialog" data-control="<?php echo $ventaEliminarControl; ?>" data-action="venta/update/particular">
