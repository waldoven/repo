...
//  echo $fecha_5;
  ...
  // search for VENTA PARTICULAR data
  ...
  //echo $sql;
    ...
    $data_venta = "<table id='ventaTabla' class='table table-hover table-sm'>
                    <thead>
  ...
  if ($accion == "deleteok") {
      ...
      if ( $del->rowCount() > 0 ) {
        ...
        $codigoControl = 'Venta '.$num_venta.' eliminada exitosamente...';
      } else {
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mt-3">
        <form class="form-horizontal" action="./delete_particular.php?accion=deleteok&numven=<?php echo $num_venta; ?>&fechaven=<?php echo $fecha_venta; ?>&rut=<?php echo $rut_cliente; ?>&nomcliente=<?php echo $nom_cliente; ?>" method="post">
          <div class="d-flex flex-column mt-3 <?php echo ($ventaBorrar)?'ocultar':'mostrar'; ?>">            
            ...
            <div class="d-flex flex-row justify-content-center mt-3">
              ...
              <a class="btn btn-outline-danger" href="../venta/read_ud.php?tipo=particular" role="button">Atras</a>
            </div>
          </div>
